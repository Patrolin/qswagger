...
sbprint_header :: proc(builder: ^strings.Builder) {
	fmt.sbprintln(builder, "/* tslint:disable */")
	fmt.sbprintln(builder, "/* eslint-disable */")
	fmt.sbprintln(builder, "/**")
	fmt.sbprintln(
		builder,
		" * NOTE: This file is auto-generated by qswagger (https://github.com/Patrolin/qswagger)",
	)
	fmt.sbprintln(builder, " * Do NOT edit it manually")
	fmt.sbprintln(builder, " */")
}
